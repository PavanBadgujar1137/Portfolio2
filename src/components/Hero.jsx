...
const Hero = () => {
  return (
    ...
    <div id='home-section' className="flex flex-col md:flex-row w-full h-auto items-center gap-4 justify-between mx-auto md:mt-[34px] md:px-[55px] bg-[#F0F0F5] rounded-md p-3 overflow-visible">
        ...
        <div className="md:w-[55%] w-full flex flex-col flex-wrap md:px-[10px] text-center md:text-left font-Poppins">
            ...
            <p className="font-bold text-black md:text-[49px]">I am  <span className='md:text-[20px] text-[8px]  text-[#5E3AEE] font-semibold'>
              <TypeAnimation
  ...
  />
            ...
            <div className="flex flex-wrap text-center md:text-start text-black font-medium text-[15px] md:text-[20px] md:mb-[15px]">Welcome to my portfolio! I'm a software developer with internship experience at Oasis Infobyte and LearnSmasher. Check out my GitHub for a variety of web development projects showcasing my skills and creativity.</div>
            {/* <!-- Contact and Projects Buttons --> */}
            <div className="flex flex-col  md:flex-row gap-6">
               <a href="https://drive.google.com/file/d/1zxVxRPcSR-7JCx4PvmbTsX0Ny2In8oZm/view"><button type="button" className="md:w-[185px] md:h-[50px] text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800">Resume</button></a> 
